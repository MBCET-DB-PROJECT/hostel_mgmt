    ...
    <div>
      ...
      <div className="flex">
        ...
        <div className="md:block md:w-5/6 bg-slate-200 h-screen w-full flex justify-center items-center">
          <div className="flex justify-around  bg-red-100 mx-5 mt-5 space-x-5 h-5/6">
            <div className="bg-green-200 p-4 w-1/3">
            ...
            <div className="bg-yellow-200 p-4 w-1/3 right-0">
              <h1 className="flex justify-center font-semibold text-2xl">
                Unoccupied Rooms
              </h1>
            </div>
          ...
          <div className="mt-2 flex justify-center">
            <button className="px-4 py-2 rounded-md bg-black text-white flex hover:bg-gray-800">
